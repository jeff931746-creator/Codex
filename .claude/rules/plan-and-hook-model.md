...
| `doc-change` edit produces a design document but `self-review` was not delegated to a subagent | block delivery, run subagent review before proceeding; subagent must use the three criteria in `reference/部门标准/策划/current/GDD写作标准.md` |
