...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市咖啡店
cultural_paradigm: 女神经营+日常恋爱
narrative_core: 经营养成+后宫恋爱
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 经营咖啡店的同时与多位女神培养感情

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [恋爱日常, 职场日常, 日常喜剧]
visual_tags: [咖啡馆, 都市夜景, 校园青春, 日常温馨]
...
# === 素材与玩法 ===
material_hooks: [女神立绘, 咖啡店场景, 约会互动, 温馨日常]
existing_games: []
