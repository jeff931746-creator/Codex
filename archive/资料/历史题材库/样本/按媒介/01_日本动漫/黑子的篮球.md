...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 篮球+超能力体育
narrative_core: 团队对决与成长
...
t_can_carry: [T2, T4]
core_emotion_note: ""
core_conflict: 黑子与火神带领诚凛挑战奇迹的世代，争夺日本第一

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 体育竞技
theme_secondary: [篮球, 校园, 友情]
visual_tags: [校园, 操场, 青春热血, 武器对决]
...
# === 素材与玩法 ===
material_hooks: [超高速运球, Zone状态爆发, 三分球无死角, 空中接力灌篮, 团队默契配合]
existing_games: [黑子的篮球 手游]
