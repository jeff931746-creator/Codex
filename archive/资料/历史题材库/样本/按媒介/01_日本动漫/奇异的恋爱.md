...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 魔法少女+恋爱喜剧
narrative_core: 少年与魔法少女恋爱
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 少年与魔法少女在平凡校园与奇幻战斗间维系恋爱关系

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [校园恋爱, 日常喜剧, 奇幻]
visual_tags: [校园, 魔法阵, 变身场景, 甜蜜约会]
...
# === 素材与玩法 ===
material_hooks: [魔法少女变身, 校园日常互动, 甜蜜约会场景, 战斗与恋爱反差]
existing_games: []
