---
# === 身份 ===
work_id: WORK-ANI-00651
work_name: To Heart ～Remember my Memories～
work_name_alt: []
media_type: ANI
year_first: 2004
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 机器人少女+校园日常
narrative_core: 人与机器人的温情羁绊
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 人类与机器人少女之间的情感羁绊与身份认同

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 日常喜剧, 异能学院]
...
# === 素材与玩法 ===
material_hooks: [机器人少女日常, 校园樱花场景, 温馨互动画面, 记忆碎片闪回]
existing_games: []
