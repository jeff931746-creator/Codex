---
# === 身份 ===
work_id: WORK-ANI-00750
work_name: Just Because!
work_name_alt: []
media_type: ANI
year_first: 2017
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本高中
cultural_paradigm: 校园青春+恋爱日常
narrative_core: 毕业前恋情抉择
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 毕业前夕，暗恋与告白之间的犹豫与错过

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 日常喜剧, 毕业季]
visual_tags: [校园, 教室, 车站, 烟花大会, 冬日校园]
...
# === 素材与玩法 ===
material_hooks: [冬日校园, 黄昏教室, 车站告别, 烟花大会, 雨伞下对视]
existing_games: []
