...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本都市校园
cultural_paradigm: 灵异鬼怪+日常喜剧体系
narrative_core: 恐怖日常与强装镇定
...
t_can_carry: [T1, T2]
core_emotion_note: ""
core_conflict: 少女能看见常人看不见的鬼怪，必须强装镇定维持日常

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恐怖
theme_secondary: [灵异, 日常喜剧, 校园]
visual_tags: [校园, 都市夜景, 灵异, 搞笑荒诞]
...
# === 素材与玩法 ===
material_hooks: [鬼怪突然出现, 女主惊恐表情, 强装镇定日常, 鬼怪搞笑互动]
existing_games: []
