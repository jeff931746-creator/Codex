...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 电玩社+误会恋爱
narrative_core: 误会闹剧+青春恋爱
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 电玩社成员因误会不断引发恋爱闹剧

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 日常喜剧, 社团活动]
visual_tags: [校园, 教室, 操场, 日常温馨]
...
# === 素材与玩法 ===
material_hooks: [误会连环碰撞, 电玩社日常, 青春校园场景, 角色表情包]
existing_games: []
