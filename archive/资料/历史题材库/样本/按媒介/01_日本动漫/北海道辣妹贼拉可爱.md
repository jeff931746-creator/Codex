...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本北海道
cultural_paradigm: 校园恋爱+地域文化
narrative_core: 甜蜜恋爱日常
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 东京少年与北海道辣妹的甜蜜恋爱日常

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [校园恋爱, 都市, 日常喜剧]
visual_tags: [校园青春, 雪景, 都市夜景]
...
# === 素材与玩法 ===
material_hooks: [辣妹笑容, 雪景约会, 校园互动, 地域风情]
existing_games: []
