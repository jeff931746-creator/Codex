...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本都市
cultural_paradigm: 退魔+阴阳术
narrative_core: 悲剧宿命+姐妹羁绊
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 姐妹因宿命对立，在悲剧中守护羁绊

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 奇幻
theme_secondary: [友情, 亲情, 都市, 悬疑]
visual_tags: [神社结界, 退魔刀光, 灵兽召唤, 都市夜景, 姐妹对峙]
...
# === 素材与玩法 ===
material_hooks: [退魔刀光, 灵兽召唤, 姐妹对峙, 神社结界]
existing_games: []
