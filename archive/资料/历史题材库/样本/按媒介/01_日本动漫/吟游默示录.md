...
# === 三要素(v0 已有,迁移直翻)===
environment: 欧洲贵族学院
cultural_paradigm: 美少年+贵族社交
narrative_core: 青春成长与羁绊
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 贵族学院中少年们的青春羁绊与身份差异

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 日常喜剧, 都市]
visual_tags: [校园, 教室, 古堡, 蔷薇庭院, 欧式学院服]
...
# === 素材与玩法 ===
material_hooks: [美少年群像, 欧式学院服, 烛光晚宴, 蔷薇庭院]
existing_games: []
