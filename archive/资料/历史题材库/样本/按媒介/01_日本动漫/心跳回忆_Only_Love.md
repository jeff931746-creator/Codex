---
# === 身份 ===
work_id: WORK-ANI-00519
work_name: 心跳回忆 Only Love
work_name_alt: []
media_type: ANI
year_first: 2006
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 校园恋爱+日常青春
narrative_core: 平凡少年的恋爱物语
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 平凡少年在校园中追求心仪女孩，克服羞涩与误会

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 日常喜剧, 社团活动]
visual_tags: [校园, 教室, 操场, 樱花, 青春阳光]
...
# === 素材与玩法 ===
material_hooks: [校园樱花场景, 心跳特写镜头, 告白瞬间, 日常互动]
existing_games: [心跳回忆系列游戏]
