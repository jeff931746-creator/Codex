...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 青春恋爱+心理成长
narrative_core: 反差恋爱+自我救赎
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 自卑少年与阳光少女的暗恋与双向救赎

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 日常喜剧, 友情]
visual_tags: [校园, 教室, 图书馆, 都市夜景, 恋爱甜蜜]
...
# === 素材与玩法 ===
material_hooks: [图书馆对视, 递零食瞬间, 雨中奔跑, 脸红特写, 天台告白]
existing_games: []
