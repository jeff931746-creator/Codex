...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 共享痛觉的超能力体系
narrative_core: 羁绊与情感连接
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 共享痛觉的少年少女在情感连接中寻找自我与羁绊

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 异能学院, 日常喜剧]
visual_tags: [校园, 教室, 都市夜景, 魔法阵, 青春校园]
...
# === 素材与玩法 ===
material_hooks: [痛觉共享画面, 羁绊者标记, 情感爆发场景, 校园日常反差]
existing_games: []
