...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 天才推理+组织暗战
narrative_core: 悬疑解谜+宿命对决
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 天才少年用推理对抗组织宿命，在兄弟羁绊中寻找真相

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 校园, 友情, 都市]
visual_tags: [校园, 都市夜景, 武器对决, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [天才对决, 谜题现场, 宿命兄弟, 组织暗影]
existing_games: []
