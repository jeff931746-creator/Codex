...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本小学
cultural_paradigm: 小学生乐队+音乐
narrative_core: 音乐成长与治愈
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 内向少年通过乐队与小学生建立羁绊，治愈彼此孤独

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 社团活动, 日常喜剧]
visual_tags: [校园, 教室, 音乐舞台, 阳光治愈]
...
# === 素材与玩法 ===
material_hooks: [小学生演奏, 萌系角色, 音乐舞台, 治愈日常]
existing_games: []
