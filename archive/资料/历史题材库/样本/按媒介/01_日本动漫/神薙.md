...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 神道文化+日常喜剧
narrative_core: 少年与神女的日常
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 少年与神女在校园日常中磨合关系，守护神性秘密

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [校园, 喜剧, 恋爱, 日常喜剧]
visual_tags: [校园, 神社, 教室, 古风装扮, 阳光治愈]
...
# === 素材与玩法 ===
material_hooks: [神女木雕觉醒, 校园祭闹剧, 神社日常, 萌系角色互动]
existing_games: []
