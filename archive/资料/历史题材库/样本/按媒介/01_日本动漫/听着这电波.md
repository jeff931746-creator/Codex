...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本广播界
cultural_paradigm: 广播行业职场
narrative_core: 荒诞广播人生
...
t_can_carry: [T1]
core_emotion_note: ""
core_conflict: 女主在荒诞广播中寻找自我表达的自由

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [职场, 喜剧, 日常喜剧]
visual_tags: [都市夜景, 霓虹灯, 老街巷, 咖啡馆]
...
# === 素材与玩法 ===
material_hooks: [深夜广播室, 个性录音设备, 荒诞直播场景, 角色夸张表情]
existing_games: []
