...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市+圣杯战争
cultural_paradigm: 英灵召唤+宝具对决
narrative_core: 圣杯争夺与信念碰撞
...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 七组御主与英灵争夺圣杯，信念与宿命的碰撞

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 奇幻
theme_secondary: [神话, 冒险, 都市, 战争]
visual_tags: [魔法阵, 武器对决, 古堡, 都市夜景, 爆炸场面]
...
# === 素材与玩法 ===
material_hooks: [英灵宝具对决, Saber誓约剑, 无限剑制展开, 凛与士郎战斗, 圣杯黑泥侵蚀]
existing_games: [Fate/Grand Order, Fate/EXTELLA, Fate/Samurai Remnant]
