---
# === 身份 ===
work_id: WORK-ANI-00523
work_name: 魔女猎人》（2007，日本，女猎人护送魔女逃亡）
work_name_alt: []
media_type: ANI
year_first: 2007
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代美国西部+荒野
cultural_paradigm: 枪械战斗+魔女超能力
narrative_core: 公路逃亡与守护羁绊
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 女猎人护送魔女逃亡，对抗追捕与内部猜疑

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 冒险
theme_secondary: [求生, 友情, 都市, 奇幻]
visual_tags: [荒野, 小镇, 枪战, 魔女超能力]
...
# === 素材与玩法 ===
material_hooks: [枪战对决, 荒野追逐, 魔女超能力, 西部小镇]
existing_games: []
