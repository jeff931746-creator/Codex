...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市+转世神话
cultural_paradigm: 天使转世+守护者契约
narrative_core: 守护与羁绊
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 守护天使与转世主人之间羁绊的建立与危机

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 奇幻
theme_secondary: [恋爱, 校园, 都市, 神话]
visual_tags: [校园, 都市夜景, 天使变身画面, 温馨互动场景, 阳光治愈]
...
# === 素材与玩法 ===
material_hooks: [天使变身画面, 萌系角色日常, 守护契约仪式, 温馨互动场景]
existing_games: []
recommended_playstyles: []
risk_notes: [受众窄, 版权成本低, 付费浅]
