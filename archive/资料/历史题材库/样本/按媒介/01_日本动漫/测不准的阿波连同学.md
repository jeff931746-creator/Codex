...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代校园日常
cultural_paradigm: 社交距离喜剧体系
narrative_core: 恋爱喜剧与社交破冰
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 极度怕生的少女与天然呆少年之间，如何突破社交距离的恋爱喜剧
...
# === 素材与玩法 ===
material_hooks: [阿波连的呆萌表情, 两人距离忽近忽远, 校园日常小互动, 反差萌动作特写]
existing_games: []
