...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本+英灵战场
cultural_paradigm: 英灵召唤+魔术体系
narrative_core: 圣杯战争+生死对决
...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 七组御主与英灵争夺圣杯，生死对决中交织羁绊与背叛

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 奇幻
theme_secondary: [魔法, 神话, 都市, 战争]
visual_tags: [魔法阵, 武器对决, 古堡, 都市夜景]
...
# === 素材与玩法 ===
material_hooks: [英灵宝具对轰, 圣杯战争契约, 魔术刻印战斗, 王座之剑投影]
existing_games: [Fate/stay night, Fate/Grand Order]
