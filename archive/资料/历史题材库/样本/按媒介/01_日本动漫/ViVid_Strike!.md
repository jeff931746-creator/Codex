---
# === 身份 ===
work_id: WORK-ANI-00295
work_name: ViVid Strike!
work_name_alt: []
media_type: ANI
year_first: 2016
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市格斗擂台
cultural_paradigm: 魔法少女格斗体系
narrative_core: 复仇与成长逆袭
...
t_can_carry: [T2, T4]
core_emotion_note: ""
core_conflict: 少女在格斗擂台上复仇逆袭，同时争夺团队中的位置与认可

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [校园, 友情, 体育竞技]
visual_tags: [擂台, 魔法阵, 格斗场面, 都市夜景]
...
# === 素材与玩法 ===
material_hooks: [魔法少女格斗, 擂台对决场面, 复仇逆袭瞬间, 角色受伤特写]
existing_games: []
