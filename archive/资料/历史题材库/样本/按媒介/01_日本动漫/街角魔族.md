...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代小镇日常
cultural_paradigm: 魔族少女+日常魔法体系
narrative_core: 废柴魔族与日常搞笑
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 废柴魔族少女与魔法少女的日常搞笑与羁绊

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 喜剧
theme_secondary: [日常喜剧, 奇幻, 友情]
visual_tags: [校园, 小镇温馨, 可爱角色表情, 魔法阵]
...
# === 素材与玩法 ===
material_hooks: [魔族少女日常, 魔法少女互动, 可爱角色表情, 小镇温馨场景]
existing_games: []
