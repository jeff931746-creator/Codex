...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 校园日常+多角恋喜剧
narrative_core: 搞笑日常+恋爱误会
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 一群高中生围绕多角暗恋与误会展开的搞笑日常
...
# === 素材与玩法 ===
material_hooks: [校园走廊追逐, 夸张表情特写, 恋爱误会场景, 运动会乱斗]
existing_games: [校园迷糊大王：恋爱模拟]
