...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 兄妹禁忌之恋与校园日常的冲突

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [校园恋爱, 禁忌恋爱, 日常喜剧, 家庭]
visual_tags: [校园, 教室, 操场, 都市夜景, 恋爱甜蜜]
...
# === 素材与玩法 ===
material_hooks: [兄妹同居日常, 校园祭典场景, 雨中共伞画面, 脸红对视瞬间]
existing_games: []
