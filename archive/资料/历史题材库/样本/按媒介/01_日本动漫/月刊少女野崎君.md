...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 少女漫画创作日常
narrative_core: 搞笑日常+恋爱喜剧
...
t_can_carry: [T1, T3]
core_emotion_note: ""
core_conflict: 少女漫画家与助手们的日常搞笑与恋爱误会

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 喜剧
theme_secondary: [日常喜剧, 校园恋爱, 职场日常]
...
# === 素材与玩法 ===
material_hooks: [少女漫改现场, 反差萌角色, 校园社团场景, 搞笑表情包]
existing_games: []
