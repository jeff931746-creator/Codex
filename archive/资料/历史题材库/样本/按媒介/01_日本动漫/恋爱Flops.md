...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本校园
cultural_paradigm: 恋爱喜剧+奇幻反转
narrative_core: 伪后宫真相揭秘
...
t_can_carry: [T3, T5]
core_emotion_note: ""
core_conflict: 男主在伪后宫日常中揭开AI女友们的真相

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [校园恋爱, 日常喜剧]
visual_tags: [校园, 教室, 都市夜景, 日常温馨, 搞笑荒诞]
...
# === 素材与玩法 ===
material_hooks: [美少女日常互动, 校园恋爱场景, 反转真相揭露]
existing_games: []
