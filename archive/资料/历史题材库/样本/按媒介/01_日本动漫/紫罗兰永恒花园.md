...
# === 三要素(v0 已有,迁移直翻)===
environment: 架空近现代欧洲
cultural_paradigm: 代笔职业+情感文学
narrative_core: 寻找爱+自我救赎
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 战争创伤的少女代笔寻找爱的意义

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 亲情
theme_secondary: [战争, 都市, 职场]
visual_tags: [欧式复古街道, 打字机与信件, 蓝色眼眸特写, 湖光山色场景, 古风诗意]
...
# === 素材与玩法 ===
material_hooks: [欧式复古街道, 打字机与信件, 蓝色眼眸特写, 湖光山色场景]
existing_games: []
