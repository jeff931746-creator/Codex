---
# === 身份 ===
work_id: WORK-ANI-00788
work_name: Opus.COLORs
work_name_alt: []
media_type: ANI
year_first: 2023
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本艺术校园
cultural_paradigm: 绘画创作+青春友情
narrative_core: 天才成长+挚友羁绊
...
t_can_carry: [T3, T2]
core_emotion_note: ""
core_conflict: 天才画家与挚友在艺术道路上相互竞争与扶持

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 校园
theme_secondary: [青春恋爱, 社团活动, 友情]
visual_tags: [校园, 教室, 操场, 阳光治愈]
...
# === 素材与玩法 ===
material_hooks: [校园画室场景, 颜料飞溅画面, 画作特写, 青春奔跑剪影]
existing_games: []
