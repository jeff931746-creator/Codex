...
# === 三要素(v0 已有,迁移直翻)===
environment: 日本昭和时代
cultural_paradigm: 落语艺术+师徒传承
narrative_core: 艺术传承+悲剧
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 落语艺术的传承与个人悲剧命运的纠缠

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 传记
theme_secondary: [师徒情, 历史, 都市]
visual_tags: [昭和街景, 落语舞台, 和服姿态, 时代变迁, 古风装扮]
...
# === 素材与玩法 ===
material_hooks: [昭和街景, 落语舞台, 和服姿态, 时代变迁]
existing_games: []
