...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代东京歌舞伎町
cultural_paradigm: 侦探推理+黑帮文化
narrative_core: 破案解谜+群像博弈
...
t_can_carry: [T5, T4]
core_emotion_note: ""
core_conflict: 侦探们在歌舞伎町破解谜案，同时卷入黑帮势力博弈

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 犯罪, 都市, 黑帮帝国]
visual_tags: [都市夜景, 霓虹灯, 老街巷, 侦探事务所]
...
# === 素材与玩法 ===
material_hooks: [霓虹灯下的暗巷, 侦探事务所内景, 角色对峙剪影, 案件现场线索]
existing_games: []
