...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本妖怪世界
cultural_paradigm: 付丧神+战斗契约体系
narrative_core: 少年与付丧神共战
...
t_can_carry: [T3, T2]
core_emotion_note: ""
core_conflict: 少年与付丧神并肩战斗，对抗妖怪世界的黑暗势力

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 奇幻
theme_secondary: [都市, 冒险, 友情]
visual_tags: [妖怪都市夜景, 契约纹章发光, 武器具象化, 付丧神变身]
...
# === 素材与玩法 ===
material_hooks: [付丧神变身, 契约纹章发光, 妖怪都市夜景, 武器具象化]
existing_games: []
