...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代日本都市
cultural_paradigm: 魔法少女+大逃杀体系
narrative_core: 残酷生存与背叛
...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 魔法少女们被迫互相残杀以争夺生存资格

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 奇幻
theme_secondary: [求生, 恐怖, 悬疑, 都市]
visual_tags: [魔法少女变身, 血腥战斗, 都市夜景, 黑暗压抑]
...
# === 素材与玩法 ===
material_hooks: [魔法少女变身, 血腥战斗, 角色惨死, 背叛瞬间]
existing_games: []
