...
# === 三要素(v0 已有,迁移直翻)===
environment: 1970年代美国社会
cultural_paradigm: 政治运动+女性主义对抗
narrative_core: 政治博弈+历史再现
...
t_can_carry: [T4]
core_emotion_note: ""
core_conflict: 保守派与女权运动的政治博弈，ERA法案存废之争

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 政治权谋
theme_secondary: [历史, 职场, 家庭, 女性独立]
visual_tags: [70年代复古, 国会听证会, 家庭场景, 职场冲突]
...
# === 素材与玩法 ===
material_hooks: [70年代复古服饰, 国会听证会场景, 女性领袖对峙, 家庭与职场冲突]
existing_games: []
