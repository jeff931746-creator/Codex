...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 幸存者争夺资源与权力，对抗末日秩序崩塌

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 末日
theme_secondary: [文明崩溃, 求生, 资源枯竭, 战争]
visual_tags: [废墟, 天启四骑士, 天使与恶魔对峙, 末日紧张]
...
# === 素材与玩法 ===
material_hooks: [天启四骑士, 末日废墟, 审判日场景, 天使与恶魔对峙]
existing_games: []
