...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代美国法医中心
cultural_paradigm: 法医鉴定体系
narrative_core: 破案解谜与自我成长
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 法医通过尸检破解悬案，同时面对自身创伤与职业挑战

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 犯罪, 职场, 成长]
visual_tags: [法医实验室, 解剖台, 显微镜, 犯罪现场还原]
...
# === 素材与玩法 ===
material_hooks: [解剖台特写, 显微镜下证据, 犯罪现场还原, 法医实验室]
existing_games: []
