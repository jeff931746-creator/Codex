...
t_can_carry: [T4, T5]
core_emotion_note: ""
core_conflict: 天才律师与检察官在法庭上博弈，揭露真相与掩盖罪行的较量

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 律政, 智斗, 犯罪]
visual_tags: [法庭, 西装, 证据文件, 紧张对峙]
...
# === 素材与玩法 ===
material_hooks: [法庭对峙, 证据反转, 角色表情特写, 庭审现场]
existing_games: []
