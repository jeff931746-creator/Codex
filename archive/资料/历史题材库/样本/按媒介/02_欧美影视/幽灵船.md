...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 船员在幽灵船上求生并解开诅咒之谜

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恐怖
theme_secondary: [求生, 悬疑, 超自然悬疑, 灵异]
visual_tags: [古堡, 废墟, 海洋, 黑暗压抑]
...
# === 素材与玩法 ===
material_hooks: [幽灵船阴森场景, 诡异灯光闪烁, 船员惊恐表情, 船体锈蚀细节]
existing_games: []
