...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市
cultural_paradigm: 侠盗团队+高科技犯罪
narrative_core: 团队劫富济贫
...
t_can_carry: [T4, T3]
core_emotion_note: ""
core_conflict: 团队劫富济贫对抗腐败权贵

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [犯罪, 冒险, 智斗, 复仇]
visual_tags: [都市夜景, 霓虹灯, 摩天楼, 高科技装备, 黑色西装]
...
# === 素材与玩法 ===
material_hooks: [高科技装备, 团队配合, 反转计谋, 目标豪宅]
existing_games: []
