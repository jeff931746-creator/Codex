...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 单亲父亲与儿子在伦敦新生活中重建家庭关系

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 家庭
theme_secondary: [父子, 单亲家庭, 日常喜剧, 校园]
visual_tags: [都市夜景, 校园, 公寓, 日常温馨, 搞笑荒诞]
...
# === 素材与玩法 ===
material_hooks: [父子日常互动, 英式幽默场景, 校园生活片段]
existing_games: []
