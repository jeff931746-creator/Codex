...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 失忆特工对抗CIA追杀，同时追寻自己真实身份

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [特工任务, 身份谜团, 谍战]
visual_tags: [都市夜景, 追车漂移, 近身格斗, CIA监控室]
...
# === 素材与玩法 ===
material_hooks: [伯恩近身格斗, 追车漂移镜头, CIA监控室, 护照与假身份, 摩洛哥追逐战]
existing_games: []
