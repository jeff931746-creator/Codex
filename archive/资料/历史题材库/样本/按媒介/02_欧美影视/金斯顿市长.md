...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代美国监狱小镇
cultural_paradigm: 家族操控+监狱黑幕
narrative_core: 权力斗争与灰色生存
...
t_can_carry: [T4]
core_emotion_note: ""
core_conflict: 市长家族与监狱黑帮争夺小镇控制权

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 政治权谋
theme_secondary: [黑帮帝国, 权力游戏, 犯罪, 都市]
visual_tags: [监狱铁网, 街头枪战, 都市夜景, 权力交易]
...
# === 素材与玩法 ===
material_hooks: [监狱铁网, 家族对峙, 街头枪战, 权力交易]
existing_games: []
