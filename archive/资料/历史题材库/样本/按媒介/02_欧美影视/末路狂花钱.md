...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市动作片场
cultural_paradigm: 特技动作+悬疑破案
narrative_core: 特技演员寻人破案
...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 特技演员在片场追查失踪案，动作与谜题交织

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 都市, 复仇]
visual_tags: [都市夜景, 爆炸场面, 飞车追逐, 片场迷宫]
...
# === 素材与玩法 ===
material_hooks: [飞车追逐, 高空坠落, 爆破场面, 片场迷宫]
existing_games: []
