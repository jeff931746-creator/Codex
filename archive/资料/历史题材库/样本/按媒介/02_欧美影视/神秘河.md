...
t_can_carry: [T4]
core_emotion_note: ""
core_conflict: 三个童年好友因一桩谋杀案被卷入猜忌与复仇的漩涡

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 复仇, 心理悬疑, 友情]
visual_tags: [雨夜, 河畔, 酒吧, 都市夜景, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [河畔尸体发现, 雨夜追凶场景, 酒吧对峙气氛, 童年回忆闪回]
existing_games: []
