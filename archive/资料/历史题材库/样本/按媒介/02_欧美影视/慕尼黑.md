...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 慕尼黑惨案后，以色列特工跨国追杀恐怖分子，复仇与正义的边界模糊

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 犯罪
theme_secondary: [复仇, 谍战, 历史, 政治权谋]
visual_tags: [都市夜景, 枪林弹雨, 冷战质感, 特工伪装]
...
# === 素材与玩法 ===
material_hooks: [暗杀行动, 冷战柏林, 特工伪装, 复仇名单]
existing_games: []
