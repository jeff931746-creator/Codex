...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市法律界
cultural_paradigm: 超能力+法庭辩论
narrative_core: 超能破案+逆袭
...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 律师用超能力破解悬案，对抗不公与强权

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [职场, 悬疑, 超能力, 逆袭]
visual_tags: [都市夜景, 法庭, 西装, 全息投影]
...
# === 素材与玩法 ===
material_hooks: [超能力庭审, 逆转证据, 法庭对峙, 案件反转]
existing_games: []
