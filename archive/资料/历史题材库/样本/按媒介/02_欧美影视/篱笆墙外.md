...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 森林动物与人类社区争夺生存空间，同时内部关系面临考验

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 喜剧
theme_secondary: [家庭, 求生, 都市, 成长]
visual_tags: [森林, 郊区, 动物拟人化, 日常温馨]
...
# === 素材与玩法 ===
material_hooks: [动物拟人化, 森林与郊区对比, 食物争夺战, 动物家庭互动]
existing_games: []
