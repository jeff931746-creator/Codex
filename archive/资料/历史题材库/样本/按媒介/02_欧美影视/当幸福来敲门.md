...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 主角在贫困中坚持奋斗，最终实现职业与人生逆袭

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 传记
theme_secondary: [励志, 成长, 父子, 职场]
visual_tags: [都市夜景, 公寓, 街头, 西装革履, 阳光治愈]
...
# === 素材与玩法 ===
material_hooks: [父子相依为命, 街头推销骨密度仪, 面试西装革履, 厕所过夜场景, 魔方破解机会]
existing_games: []
