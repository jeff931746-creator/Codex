...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 小镇冤案引发家族与司法系统的权力博弈与复仇

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 复仇, 家庭秘密, 心理悬疑]
visual_tags: [小镇阴郁氛围, 雪地血迹, 法庭对峙, 角色眼神特写]
...
# === 素材与玩法 ===
material_hooks: [小镇阴郁氛围, 法庭对峙场景, 角色眼神特写, 雪地血迹]
existing_games: []
