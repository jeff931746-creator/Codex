...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 主角在未知世界中不断变强，破解谜题与敌人

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 冒险
theme_secondary: [成长, 战斗, 奇幻, 热血战斗]
visual_tags: [战斗特效爆发, 场景压迫感, 装备进化展示, 未知世界]
...
# === 素材与玩法 ===
material_hooks: [主角成长轨迹, 战斗特效爆发, 场景压迫感, 装备进化展示]
existing_games: []
