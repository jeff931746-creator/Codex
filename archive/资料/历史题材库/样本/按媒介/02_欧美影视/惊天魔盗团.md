...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 魔术师团队用惊天骗局对抗腐败势力，同时隐藏自身秘密

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 犯罪
theme_secondary: [复仇, 智斗, 都市, 悬疑]
visual_tags: [都市夜景, 魔术表演, 霓虹灯, 爆炸场面]
...
# === 素材与玩法 ===
material_hooks: [魔术表演奇观, 四骑士角色, FBI追捕, 雨滴倒流特效, 扑克牌雨]
existing_games: []
