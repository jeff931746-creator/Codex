...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代反恐战场
cultural_paradigm: 特种部队战术体系
narrative_core: 精英特战队终极任务
...
t_can_carry: [T2, T4]
core_emotion_note: ""
core_conflict: 精英特战队在反恐战场上执行终极任务，面临生死考验与团队信任危机

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 战争
theme_secondary: [反恐战争, 军事行动, 特工任务, 小队求生]
visual_tags: [夜视镜突袭, 直升机索降, CQB室内近战, 战场残酷]
...
# === 素材与玩法 ===
material_hooks: [特种战术动作, 夜视镜突袭, 直升机索降, CQB室内近战]
existing_games: []
