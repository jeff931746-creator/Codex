...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代深海+海洋世界
cultural_paradigm: 巨兽生物+深海探险
narrative_core: 巨兽袭击+生存逃生
...
t_can_carry: [T1, T2]
core_emotion_note: ""
core_conflict: 人类在深海中对抗巨齿鲨的致命猎杀

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 灾难
theme_secondary: [求生, 冒险, 恐怖, 怪兽]
visual_tags: [深海, 海洋, 巨兽, 血盆大口]
...
# === 素材与玩法 ===
material_hooks: [巨齿鲨巨口突袭, 深海幽暗场景, 鲨鱼追击快艇, 血盆大口特写]
existing_games: []
recommended_playstyles: []
risk_notes: [IP热度有限, 玩法同质化]
