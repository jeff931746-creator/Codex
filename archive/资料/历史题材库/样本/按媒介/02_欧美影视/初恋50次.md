...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代夏威夷海岛
cultural_paradigm: 浪漫喜剧+短期记忆障碍
narrative_core: 每日重新追求的爱情
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 男主每天重新追求失忆女友，对抗遗忘的循环

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [都市, 喜剧, 日常喜剧, 成长]
visual_tags: [海洋, 阳光治愈, 都市繁华, 咖啡馆]
...
# === 素材与玩法 ===
material_hooks: [夏威夷海滩, 每日初遇, 记忆重置, 浪漫告白]
existing_games: []
