...
# === 三要素(v0 已有,迁移直翻)===
environment: 近未来战场
cultural_paradigm: 时间循环+机甲战斗
narrative_core: 时间循环成长
...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 主角在时间循环中不断死亡重生，从懦夫成长为战神，对抗外星入侵

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 科幻
theme_secondary: [时间轮回, 外星入侵, 机甲, 战争, 成长]
visual_tags: [机甲, 战场废墟, 外星生物, 爆炸场面, 近未来质感]
...
# === 素材与玩法 ===
material_hooks: [机甲战斗场面, 时间重置特效, 外星生物压迫感, 战场废墟]
existing_games: []
