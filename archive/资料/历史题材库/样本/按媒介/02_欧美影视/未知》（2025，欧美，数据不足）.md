---
# === 身份 ===
work_id: WORK-TVW-01352
work_name: 未知》（2025，欧美，数据不足）
work_name_alt: []
media_type: TVW
year_first: 2025
...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 主角在未知世界中不断变强以生存

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 冒险
theme_secondary: [成长, 战斗, 求生]
visual_tags: [未知世界, 战斗场面, 角色成长, 生存绝望]
...
# === 素材与玩法 ===
material_hooks: [未知世界探索, 战斗场面, 角色成长]
existing_games: []
