...
t_can_carry: [T4]
core_emotion_note: ""
core_conflict: 同性恋者米尔克在保守社会中为平权而斗争

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 传记
theme_secondary: [政治权谋, 都市, 犯罪, 成长, 救赎]
visual_tags: [都市夜景, 街头游行, 演讲镜头, 同志酒吧, 政治海报]
...
# === 素材与玩法 ===
material_hooks: [街头游行, 演讲镜头, 同志酒吧, 政治海报]
existing_games: []
