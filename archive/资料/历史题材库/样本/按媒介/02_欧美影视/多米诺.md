...
t_can_carry: [T5]
core_emotion_note: ""
core_conflict: 主角通过多米诺骨牌连锁反应破解谜题与危机

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 智斗, 成长, 都市]
visual_tags: [都市夜景, 精密排列, 骨牌崩塌瞬间, 连锁反应奇观]
...
# === 素材与玩法 ===
material_hooks: [骨牌崩塌瞬间, 精密排列过程, 连锁反应奇观]
existing_games: []
