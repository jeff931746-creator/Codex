...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 符号学家与教会势力争夺圣杯秘密，真相颠覆信仰

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 历史, 犯罪, 阴谋论]
visual_tags: [古堡, 教堂, 地下墓穴, 符号解密, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [卢浮宫密室, 密码筒解密, 达芬奇画作暗藏线索, 巴黎地下墓穴, 圣杯符号]
existing_games: []
