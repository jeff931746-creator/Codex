...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 失忆主角拼凑记忆碎片，对抗操纵命运的幕后黑手

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [身份谜团, 阴谋论, 近未来, 复仇]
visual_tags: [都市夜景, 霓虹灯, 实验室, 全息投影]
...
# === 素材与玩法 ===
material_hooks: [记忆碎片拼图, 未来科技装置, 身份反转瞬间, 时间线交错]
existing_games: []
