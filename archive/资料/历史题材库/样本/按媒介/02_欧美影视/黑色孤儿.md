...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市+实验室
cultural_paradigm: 克隆人身份悬疑
narrative_core: 身份秘密与生存博弈
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 克隆人主角在追杀中揭开身份谜团，与姐妹联手对抗组织

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [科幻, 犯罪, 身份认同, 克隆人]
visual_tags: [都市夜景, 实验室, 枪林弹雨, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [克隆人面孔, 实验室逃亡, 身份互换, 追杀场景]
existing_games: []
