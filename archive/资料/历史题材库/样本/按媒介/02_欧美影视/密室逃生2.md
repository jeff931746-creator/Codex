...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市致命密室
cultural_paradigm: 机关解谜+生存挑战
narrative_core: 团队逃生与背叛
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 玩家被困致命密室，必须破解机关逃生并应对团队背叛
...
# === 素材与玩法 ===
material_hooks: [密室机关陷阱, 倒计时压迫, 团队内讧, 逃生路线反转]
existing_games: []
