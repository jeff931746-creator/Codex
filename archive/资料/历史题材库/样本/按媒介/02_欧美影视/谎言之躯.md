...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: CIA特工与恐怖分子之间的谎言博弈与权力较量

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 战争
theme_secondary: [反恐战争, 谍战, 政治权谋, 特工任务]
visual_tags: [中东战场, 爆炸场面, 审讯室, 都市夜景, 军装]
...
# === 素材与玩法 ===
material_hooks: [中东战场实拍感, 特工伪装变装, 审讯室心理战, 爆炸与追车场面]
existing_games: []
