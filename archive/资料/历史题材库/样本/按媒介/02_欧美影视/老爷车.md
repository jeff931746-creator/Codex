...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 退役老兵与邻里冲突，在帮派暴力中捍卫尊严与正义

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [犯罪, 战争, 复仇, 救赎, 阶级压迫]
visual_tags: [都市夜景, 老街巷, 枪林弹雨, 车库修车, 战场残酷]
...
# === 素材与玩法 ===
material_hooks: [老爷车独行, 枪械对峙, 车库修车, 邻里街头]
existing_games: []
