...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 吸血鬼伯爵诺斯费拉图与猎人的生死对决

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恐怖
theme_secondary: [吸血鬼, 灵异, 黑暗奇幻, 生存恐怖]
visual_tags: [古堡, 吸血鬼苍白面容, 蝙蝠群, 棺材, 黑暗压抑]
...
# === 素材与玩法 ===
material_hooks: [吸血鬼苍白面容, 古堡阴森氛围, 蝙蝠群夜袭, 棺材中的沉睡]
existing_games: []
