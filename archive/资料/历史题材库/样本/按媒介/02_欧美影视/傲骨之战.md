...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代美国法律界
cultural_paradigm: 法律博弈+职场斗争
narrative_core: 女性重生与职场逆袭
...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 女性律师在动荡职场中对抗体制不公与个人危机

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 职场
theme_secondary: [律政, 女性独立, 都市]
visual_tags: [法庭, 办公室, 都市夜景, 黑色西装]
...
# === 素材与玩法 ===
material_hooks: [法庭对峙场面, 精英律师群像, 权力博弈暗流, 女性主角蜕变]
existing_games: []
