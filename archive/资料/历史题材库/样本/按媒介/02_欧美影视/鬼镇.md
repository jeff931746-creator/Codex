...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 主角在鬼镇中生存并揭开超自然谜团

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恐怖
theme_secondary: [灵异, 悬疑, 求生, 超自然悬疑]
visual_tags: [阴森小镇, 鬼影闪现, 诡异建筑, 黑暗森林, 血月之夜]
...
# === 素材与玩法 ===
material_hooks: [阴森小镇, 鬼影闪现, 诡异建筑, 黑暗森林, 血月之夜]
existing_games: []
