...
t_can_carry: [T5]
core_emotion_note: ""
core_conflict: 侦探追查十二宫连环杀手，身份与动机成谜

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 推理, 连环案, 身份谜团]
visual_tags: [深夜跟踪场景, 警局线索墙, 受害者特写, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [杀手符号密码, 深夜跟踪场景, 警局线索墙, 受害者特写]
existing_games: []
