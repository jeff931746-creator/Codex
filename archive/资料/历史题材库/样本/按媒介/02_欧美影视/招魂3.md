...
cultural_paradigm: 驱魔+超自然调查
narrative_core: 真实案件与灵异对抗
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 驱魔师夫妇对抗恶魔附身与连环诅咒

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恐怖
theme_secondary: [灵异, 超自然悬疑, 犯罪, 救赎]
visual_tags: [古宅阴森, 驱魔仪式, 诅咒符号, 黑暗压抑]
...
# === 素材与玩法 ===
material_hooks: [恶魔附身扭曲, 驱魔仪式对峙, 古宅阴森氛围, 诅咒符号闪现]
existing_games: []
