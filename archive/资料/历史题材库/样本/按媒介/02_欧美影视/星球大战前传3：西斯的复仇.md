---
# === 身份 ===
work_id: WORK-TVW-01394
work_name: 星球大战前传3：西斯的复仇
work_name_alt: []
media_type: TVW
year_first: 2005
...
t_can_carry: [T2, T4]
core_emotion_note: ""
core_conflict: 绝地武士安纳金在黑暗面诱惑与拯救爱人的挣扎中堕落

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 太空
theme_secondary: [科幻, 战争, 政治权谋, 悲剧, 救赎]
visual_tags: [星舰内部, 光剑, 爆炸场面, 太空孤寂, 黑暗压抑]
...
# === 素材与玩法 ===
material_hooks: [光剑对决, 原力闪电, 银河议会崩塌, 安纳金黑化, 66号令屠杀]
existing_games: []
