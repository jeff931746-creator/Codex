...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代国际间谍组织
cultural_paradigm: 间谍组织+黑名单体系
narrative_core: 卧底行动+身份反转
...
t_can_carry: [T4, T5]
core_emotion_note: ""
core_conflict: 卧底在间谍组织中的身份反转与忠诚考验

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 谍战, 身份谜团, 特工任务]
visual_tags: [都市夜景, 黑色西装, 枪林弹雨, 政治紧张]
...
# === 素材与玩法 ===
material_hooks: [间谍暗战, 身份反转, 黑名单悬疑, 背叛瞬间]
existing_games: []
