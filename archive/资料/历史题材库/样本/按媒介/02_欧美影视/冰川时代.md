...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 冰河时期动物们结伴迁徙，对抗自然灾难与生存危机

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 冒险
theme_secondary: [求生, 喜剧, 友情, 自然灾难]
visual_tags: [雪原, 冰川崩塌, 动物群像, 搞笑荒诞]
...
# === 素材与玩法 ===
material_hooks: [猛犸象曼尼, 树懒希德搞笑, 松鼠斯克莱特, 冰川崩塌场景, 动物群像冒险]
existing_games: []
