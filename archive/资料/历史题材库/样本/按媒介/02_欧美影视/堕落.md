...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代欧美都市
cultural_paradigm: 刑侦+心理惊悚
narrative_core: 追凶+心理博弈
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 警探与连环杀手之间的心理博弈与追捕

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 心理悬疑, 刑侦, 连环案]
visual_tags: [都市夜景, 审讯室, 犯罪现场, 心理画像]
...
# === 素材与玩法 ===
material_hooks: [犯罪现场细节, 审讯室对峙, 心理画像过程, 追捕紧张感]
existing_games: []
