---
# === 身份 ===
work_id: WORK-LIT-00447
work_name: The Soulmate Equation
work_name_alt: []
media_type: LIT
year_first: 2021
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市基因科技
cultural_paradigm: 基因匹配+浪漫喜剧
narrative_core: 命中注定的爱情实验
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 基因匹配系统能否定义真爱，主角在数据与情感间抉择

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [都市, 喜剧, 成长]
visual_tags: [都市夜景, 咖啡馆, 实验室, 数据可视化, 浪漫约会]
...
# === 素材与玩法 ===
material_hooks: [基因匹配界面, 浪漫约会场景, 实验室相遇, 数据可视化]
existing_games: []
