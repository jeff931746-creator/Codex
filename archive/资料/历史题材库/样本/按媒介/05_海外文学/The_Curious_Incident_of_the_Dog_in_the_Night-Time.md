---
# === 身份 ===
work_id: WORK-LIT-00485
work_name: The Curious Incident of the Dog in the Night-Time
work_name_alt: []
media_type: LIT
year_first: 2003
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代英国小镇
cultural_paradigm: 自闭症视角+推理解谜
narrative_core: 少年侦探解谜
...
t_can_carry: [T5]
core_emotion_note: ""
core_conflict: 自闭症少年用逻辑破解邻居狗死之谜，同时面对家庭秘密

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 家庭, 成长, 都市]
visual_tags: [小镇街道, 教室, 数字逻辑界面, 家庭室内]
...
# === 素材与玩法 ===
material_hooks: [少年笔记推理, 数字逻辑世界, 狗尸现场, 自闭症视角]
existing_games: []
