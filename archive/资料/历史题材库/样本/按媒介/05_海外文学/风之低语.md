...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代与历史交错时空
cultural_paradigm: 书信传情+时间穿越
narrative_core: 跨时空爱恋+命运羁绊
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 跨越时空的书信能否改写命运，让相爱的人终成眷属

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [穿越转生, 都市, 时间轮回]
visual_tags: [古风装扮, 都市夜景, 钟楼, 雨中相遇, 泛黄信纸]
...
# === 素材与玩法 ===
material_hooks: [泛黄信纸, 旧式邮筒, 钟楼指针倒转, 雨中相遇]
existing_games: []
