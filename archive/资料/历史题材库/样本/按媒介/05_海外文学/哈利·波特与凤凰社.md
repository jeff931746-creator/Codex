...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代魔法世界+霍格沃茨
cultural_paradigm: 魔法学院体系+咒语战斗
narrative_core: 对抗黑暗+成长反抗
...
t_can_carry: [T2, T4]
core_emotion_note: ""
core_conflict: 哈利与邓布利多军对抗伏地魔的崛起与魔法部的压制

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 奇幻
theme_secondary: [魔法, 校园, 冒险, 成长]
visual_tags: [城堡, 魔法阵, 咒语对决, 黑暗压抑, 校园青春]
...
# === 素材与玩法 ===
material_hooks: [魔法咒语对决, 凤凰社总部, 霍格沃茨城堡, 摄魂怪与守护神, 乌姆里奇课堂]
existing_games: [《哈利·波特》系列游戏, 《霍格沃茨之遗》]
