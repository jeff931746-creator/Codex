---
# === 身份 ===
work_id: WORK-LIT-00535
work_name: People We Meet on Vacation
work_name_alt: []
media_type: LIT
year_first: 2021
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代旅行地标
cultural_paradigm: 好友变恋人+旅行回忆
narrative_core: 多年好友终成恋人
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 多年好友在旅行中从友情走向爱情

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [恋爱, 友情, 成长]
visual_tags: [都市夜景, 咖啡馆, 海洋, 阳光治愈, 恋爱甜蜜]
...
# === 素材与玩法 ===
material_hooks: [旅行地标风景, 两人互动瞬间, 回忆闪回画面, 浪漫氛围场景]
existing_games: []
