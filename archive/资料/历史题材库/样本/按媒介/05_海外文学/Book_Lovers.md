---
# === 身份 ===
work_id: WORK-LIT-00539
work_name: Book Lovers
work_name_alt: []
media_type: LIT
year_first: 2022
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代美国小镇
cultural_paradigm: 出版业背景+浪漫喜剧
narrative_core: 编辑与作家小镇邂逅
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 编辑与作家在小镇相遇，职业对立与情感吸引的拉扯

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [恋爱, 职场, 喜剧, 田园]
visual_tags: [小镇书店, 雨中漫步, 篝火夜谈, 田园清新]
...
# === 素材与玩法 ===
material_hooks: [小镇书店, 手写书稿, 雨中漫步, 篝火夜谈]
existing_games: []
