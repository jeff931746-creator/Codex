...
cultural_paradigm: 警匪对抗+扒手组织
narrative_core: 卧底博弈+正邪较量
...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 卧底警察与扒手组织之间的信任与背叛博弈

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 犯罪
theme_secondary: [都市, 复仇]
visual_tags: [都市夜景, 街头追逐, 枪林弹雨, 黑色西装]
...
# === 素材与玩法 ===
material_hooks: [街头追逐战, 扒手手法特写, 卧底身份反转, 警匪对峙场面]
existing_games: []
