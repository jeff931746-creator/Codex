---
# === 身份 ===
work_id: WORK-MVK-00293
work_name: 独家报道：良辰杀人记
work_name_alt: []
media_type: MVK
year_first: 2015
...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国新闻社
cultural_paradigm: 记者调查+连环杀人
narrative_core: 记者追凶+真相揭露
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 记者追查连环杀人案真相，与凶手和体制博弈

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 连环案, 职场, 都市]
visual_tags: [都市夜景, 新闻社, 犯罪现场照片, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [新闻社紧张氛围, 犯罪现场照片, 记者追查线索, 凶手神秘身影]
existing_games: []
recommended_playstyles: []
risk_notes: [受众中等, 红海竞争]
