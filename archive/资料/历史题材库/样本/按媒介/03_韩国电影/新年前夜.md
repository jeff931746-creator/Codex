...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市跨年夜晚
cultural_paradigm: 浪漫爱情+都市生活
narrative_core: 多线恋爱与人生抉择
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 多对情侣在跨年夜面临爱情与人生的抉择

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [恋爱, 喜剧, 成长, 日常喜剧]
visual_tags: [都市夜景, 霓虹灯, 烟花, 节日灯光]
...
# === 素材与玩法 ===
material_hooks: [跨年烟花, 都市夜景, 浪漫约会, 节日灯光]
existing_games: []
