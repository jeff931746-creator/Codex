...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 绑架自救+心理博弈
narrative_core: 演员被绑架与极限自救
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 演员被绑架后与绑匪心理博弈，极限自救

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 心理悬疑, 求生, 都市]
visual_tags: [密闭空间, 都市夜景, 面具特写, 紧张压迫]
...
# === 素材与玩法 ===
material_hooks: [密闭空间压迫, 绑匪面具特写, 自救工具细节, 反转瞬间镜头]
existing_games: []
