...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 刑侦推理+复仇体系
narrative_core: 母亲追查女儿被杀真相
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 母亲追查女儿被杀真相，在刑侦与复仇中破解谜团

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [推理, 犯罪, 复仇, 都市]
visual_tags: [都市夜景, 审讯室, 犯罪现场, 母亲追凶眼神]
...
# === 素材与玩法 ===
material_hooks: [母亲追凶眼神, 犯罪现场细节, 审讯室对峙, 复仇行动画面]
existing_games: []
