...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 都市恋爱+同居喜剧
narrative_core: 都市男女同居
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 男女主角在同居生活中碰撞出爱情火花

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [恋爱, 喜剧, 日常喜剧]
...
# === 素材与玩法 ===
material_hooks: [同居日常互动, 甜蜜对视场景, 搞笑误会桥段]
existing_games: []
