...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国公寓小区
cultural_paradigm: 连环杀手+邻里悬疑
narrative_core: 追凶+生存
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 主角在平静小区中追查连环杀手，同时保护家人安全

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [连环案, 身份谜团, 家庭秘密, 都市]
...
# === 素材与玩法 ===
material_hooks: [楼道阴影, 邻居窥视, 血迹线索, 深夜敲门]
existing_games: []
