...
cultural_paradigm: 诅咒杀人+校园恐怖
narrative_core: 生存逃生+诅咒解密
...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 学生被诅咒追杀，必须破解规则才能活命

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恐怖
theme_secondary: [校园, 求生, 悬疑]
visual_tags: [校园, 教室, 走廊, 血腥场面, 黑暗压抑]
...
# === 素材与玩法 ===
material_hooks: [血腥考场, 诅咒杀人, 校园走廊追逐, 死亡名单]
existing_games: []
