...
cultural_paradigm: 自闭症与司法正义
narrative_core: 自闭症少女目击凶案
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 自闭症少女作为唯一目击证人，对抗司法系统与偏见

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 心理悬疑, 成长]
visual_tags: [法庭, 都市夜景, 教室, 白大褂, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [法庭对峙, 自闭症视角, 凶案现场, 律师辩护, 真相揭露]
existing_games: []
