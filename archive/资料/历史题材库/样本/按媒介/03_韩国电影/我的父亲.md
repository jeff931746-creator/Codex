...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国/美国
cultural_paradigm: 寻亲剧情+文化冲突
narrative_core: 韩裔美军寻亲故事
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 韩裔美军在异国寻找失散父亲，跨越文化隔阂与身份认同

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 亲情
theme_secondary: [父子, 身份认同, 成长]
visual_tags: [军装, 韩服, 首尔街头, 美军基地, 父子重逢]
...
# === 素材与玩法 ===
material_hooks: [军装与韩服对比, 首尔街头寻亲, 美军基地场景, 父子重逢瞬间]
existing_games: []
