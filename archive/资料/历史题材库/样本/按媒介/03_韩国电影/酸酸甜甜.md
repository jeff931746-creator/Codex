...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 异地恋与职场压力
narrative_core: 异地恋考验与情感抉择
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 异地恋中信任与距离的拉扯，职场压力下的情感抉择

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [都市, 职场, 成长]
visual_tags: [都市夜景, 咖啡馆, 地铁, 校园, 公寓]
...
# === 素材与玩法 ===
material_hooks: [甜蜜约会场景, 手机屏幕对话, 车站离别瞬间, 雨中拥抱, 职场疲惫背影]
existing_games: []
