...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国
cultural_paradigm: 家庭伦理+犯罪
narrative_core: 道德困境+亲情抉择
...
t_can_carry: [T4]
core_emotion_note: ""
core_conflict: 家庭成员在犯罪与道德之间做出艰难抉择

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 家庭
theme_secondary: [亲情, 犯罪, 代际冲突]
visual_tags: [都市夜景, 雨夜追捕, 法庭审判, 家庭温情, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [家庭餐桌对峙, 雨夜追捕, 法庭审判, 破碎相框]
existing_games: []
