...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国
cultural_paradigm: 自闭症成长+温暖治愈
narrative_core: 特殊少年融入社会
...
t_can_carry: [T3, T1]
core_emotion_note: ""
core_conflict: 自闭症少年渴望被接纳，与冷漠社会的隔阂与和解

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [成长, 治愈, 家庭羁绊, 日常喜剧]
visual_tags: [校园, 都市夜景, 阳光治愈, 日常温馨]
...
# === 素材与玩法 ===
material_hooks: [少年纯真眼神, 日常温暖互动, 缓慢成长瞬间]
existing_games: []
