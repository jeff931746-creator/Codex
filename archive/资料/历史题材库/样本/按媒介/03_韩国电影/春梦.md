...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国底层社区
cultural_paradigm: 文艺情感+边缘人物
narrative_core: 多角关系+青春迷茫
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 底层青年在暧昧与孤独中寻找情感归属

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 都市
theme_secondary: [青春恋爱, 日常喜剧, 成长]
visual_tags: [都市夜景, 老街巷, 雨夜, 廉价出租屋]
...
# === 素材与玩法 ===
material_hooks: [昏暗巷弄, 雨夜对视, 廉价出租屋, 烟与酒瓶]
existing_games: []
