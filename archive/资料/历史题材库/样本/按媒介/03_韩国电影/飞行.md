...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代都市励志
cultural_paradigm: 残疾抗争+飞行梦想
narrative_core: 逆袭追梦/克服缺陷
...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 残疾少年克服身体缺陷，追逐飞行梦想
...
# === 素材与玩法 ===
material_hooks: [轮椅起飞, 天空翱翔, 逆光奔跑, 飞行器特写]
existing_games: []
recommended_playstyles: []
risk_notes: [受众窄, 玩法开发成本高]
