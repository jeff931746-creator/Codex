...
# === 三要素(v0 已有,迁移直翻)===
environment: 朝鲜王朝鸣梁海峡
cultural_paradigm: 海战战术+冷兵器火炮
narrative_core: 以少胜多的抗倭海战
...
t_can_carry: [T2, T1]
core_emotion_note: ""
core_conflict: 朝鲜水师以12艘战船对抗300艘倭寇舰队
...
# === 素材与玩法 ===
material_hooks: [龟船冲锋, 海峡漩涡, 火炮齐射, 李舜臣指挥, 海面火攻]
existing_games: []
recommended_playstyles: []
risk_notes: [历史改编风险, 版权成本高]
