...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国
cultural_paradigm: 记者调查+阴谋揭露
narrative_core: 真相追寻+社会黑幕
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 记者追寻真相对抗社会黑幕

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 都市, 阴谋论, 身份谜团]
visual_tags: [都市夜景, 霓虹灯, 暗巷, 档案室, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [暗巷追逐, 档案室搜查, 证人惊恐, 黑幕文件]
existing_games: []
