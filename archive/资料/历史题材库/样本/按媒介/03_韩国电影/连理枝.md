...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 绝症爱情+浪子回头
narrative_core: 凄美爱情+生死
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 绝症阻隔下的凄美爱情与浪子回头

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [都市, 悲剧, 恋人重逢]
visual_tags: [都市夜景, 樱花树下, 病房, 雨中拥抱, 泪眼对视]
...
# === 素材与玩法 ===
material_hooks: [雨中拥抱, 病房诀别, 樱花树下, 泪眼对视]
existing_games: []
