...
# === 三要素(v0 已有,迁移直翻)===
environment: 朝鲜光海君时代
cultural_paradigm: 古代士兵+替身体系
narrative_core: 身份错位+战争成长
...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 替身士兵在战争中寻找自我身份与生存意义

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 历史
theme_secondary: [古代战争, 成长, 身份认同, 复仇]
visual_tags: [古战场, 冷兵器冲锋, 宫廷, 战场残酷, 古风装扮]
...
# === 素材与玩法 ===
material_hooks: [朝鲜战场硝烟, 光海君宫廷, 替身士兵对峙, 冷兵器冲锋]
existing_games: []
