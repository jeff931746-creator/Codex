...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 三角恋+文艺爱情
narrative_core: 三角恋+情感抉择
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 两个男人与一个女人的情感纠葛与最终抉择

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [都市, 三角关系, 文艺, 成长]
visual_tags: [都市夜景, 咖啡馆, 樱花树下, 雨中场景]
...
# === 素材与玩法 ===
material_hooks: [雨中告白, 樱花树下, 咖啡馆对视, 分手车站]
existing_games: []
