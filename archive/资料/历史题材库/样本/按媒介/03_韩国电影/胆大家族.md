...
t_can_carry: [T2]
core_emotion_note: ""
core_conflict: 主角在恐怖家族中生存并逐步掌控局面

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恐怖
theme_secondary: [灵异, 家庭秘密, 超自然悬疑, 生存恐怖]
visual_tags: [古堡, 废墟, 黑暗压抑, 恐怖压抑]
...
# === 素材与玩法 ===
material_hooks: [家族诡异仪式, 暗黑古宅场景, 角色恐惧表情, 隐藏密室探索]
existing_games: []
