...
# === 三要素(v0 已有,迁移直翻)===
environment: 1940年代日本殖民朝鲜
cultural_paradigm: 矿工苦难+逃亡
narrative_core: 压迫+逃亡
...
t_can_carry: [T4]
core_emotion_note: ""
core_conflict: 朝鲜矿工在日军压迫下求生并策划集体逃亡

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 历史
theme_secondary: [战争, 求生, 政治权谋, 阶级压迫]
visual_tags: [矿洞, 废墟, 军装, 爆炸场面]
...
# === 素材与玩法 ===
material_hooks: [矿洞压迫感, 日军暴行, 集体逃亡, 海底隧道]
existing_games: []
