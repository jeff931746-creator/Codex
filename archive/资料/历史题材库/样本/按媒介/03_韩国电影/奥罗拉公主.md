...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 复仇+母爱
narrative_core: 母亲为女复仇杀人
...
t_can_carry: [T4, T2]
core_emotion_note: ""
core_conflict: 母亲为女复仇，对抗司法与黑帮

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 犯罪
theme_secondary: [复仇, 亲情, 都市, 悬疑]
visual_tags: [都市夜景, 暗巷, 法庭, 母亲持刀]
...
# === 素材与玩法 ===
material_hooks: [母亲持刀复仇, 法庭对峙, 女儿遗物, 暗巷追杀]
existing_games: []
