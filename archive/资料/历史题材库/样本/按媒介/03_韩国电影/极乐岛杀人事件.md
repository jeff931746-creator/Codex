...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 一群人在孤岛上互相猜忌杀戮，寻找真凶与生存之道

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [连环案, 心理悬疑]
visual_tags: [孤岛, 废墟, 血迹, 悬疑诡异]
...
# === 素材与玩法 ===
material_hooks: [孤岛封闭场景, 尸体发现瞬间, 角色对峙表情, 血迹线索特写]
existing_games: []
