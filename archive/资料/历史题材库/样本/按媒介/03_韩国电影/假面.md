...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国整形界
cultural_paradigm: 整形悬疑+连环杀人
narrative_core: 连环杀人+身份伪装
...
t_can_carry: [T5, T2]
core_emotion_note: ""
core_conflict: 整形医生通过手术伪装身份，连环杀人并掩盖真相

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 悬疑
theme_secondary: [犯罪, 连环案, 身份谜团, 心理悬疑]
visual_tags: [手术刀特写, 面具人脸, 整形前后对比, 密室尸体, 身份反转]
...
# === 素材与玩法 ===
material_hooks: [手术刀特写, 面具人脸, 整形前后对比, 密室尸体, 身份反转]
existing_games: []
