...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国都市
cultural_paradigm: 私刑复仇+司法困境
narrative_core: 复仇追凶/道德挣扎
...
t_can_carry: [T2, T5]
core_emotion_note: ""
core_conflict: 父亲追凶复仇 vs 法律与私刑的边界

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 犯罪
theme_secondary: [复仇, 悬疑, 家庭, 都市]
visual_tags: [都市夜景, 雨夜追逐, 法庭对峙, 黑暗压抑]
...
# === 素材与玩法 ===
material_hooks: [父亲持刀追凶, 少女遇害现场, 法庭对峙, 雨夜追逐]
existing_games: []
