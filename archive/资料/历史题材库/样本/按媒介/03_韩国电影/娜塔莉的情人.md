...
# === 三要素(v0 已有,迁移直翻)===
environment: 现代韩国艺术圈
cultural_paradigm: 三角恋+艺术创作
narrative_core: 情感纠葛+欲望挣扎
...
t_can_carry: [T3]
core_emotion_note: ""
core_conflict: 艺术家与情人之间的三角情感纠葛与欲望挣扎

# === 三层标签(主检索路径,见 TAGS.md)===
theme_primary: 恋爱
theme_secondary: [三角关系, 都市, 职场, 成长]
visual_tags: [都市夜景, 画廊, 画室, 暧昧氛围]
...
# === 素材与玩法 ===
material_hooks: [艺术画廊场景, 情人眼神对峙, 画室暧昧氛围, 雨中分手镜头]
existing_games: []
